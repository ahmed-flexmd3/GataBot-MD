	...
	let fsizedoc = '1'.repeat(10)    
     ...
     if (buffer) try { (type = await conn.getFile(buffer), buffer = type.data) } catch { buffer = buffer }
          ...
          forwardedNewsletterMessageInfo: {
            newsletterJid: '120363301159556694@newsletter',
...
let canalId = ["120363301159556694@newsletter", "120363301159556694@newsletter", "120363301159556694@newsletter", "120363301159556694@newsletter", "120363301159556694@newsletter"]
let canalNombre = ["bot night🤖", "NIGHT-BOT🤖", "NIGHT-BOT🤖", "NIGHT-BOT🤖", "NIGHT-BOT🤖"]
